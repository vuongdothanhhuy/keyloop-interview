...
- **`KeyloopCodingChallange.pdf`** — the original assessment brief. Several requirements were deliberately ambiguous; `SYSTEM_DESIGN.md`'s "Note on Ambiguity" section documents the assumptions made — do not silently reinterpret them.
